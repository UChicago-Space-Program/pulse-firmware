...
sd_create_scalar_port -sd_name ${sd_name} -port_name {P9_14} -port_direction {OUT} -port_is_pad {1}
sd_create_scalar_port -sd_name ${sd_name} -port_name {P9_16} -port_direction {OUT} -port_is_pad {1}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"P9_14_BIBUF:D" "pulse_signal_generator_0:output_signal" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"P9_16" "P9_16_BIBUF:PAD" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"P9_16_BIBUF:D" "pulse_signal_generator_0:output_signal_n" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"P9_PIN42" "pulse_signal_generator_0:output_clock" }
