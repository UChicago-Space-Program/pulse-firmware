...
sd_create_bus_port -sd_name ${sd_name} -port_name {AXI4mmaster0_MASTER0_ARUSER} -port_direction {IN} -port_range {[3:0]}
...
sd_create_bus_port -sd_name ${sd_name} -port_name {AXI4mmaster0_MASTER0_AWUSER} -port_direction {IN} -port_range {[3:0]}
...
sd_create_bus_port -sd_name ${sd_name} -port_name {AXI4mmaster0_MASTER0_WUSER} -port_direction {IN} -port_range {[3:0]}
...
sd_create_bus_port -sd_name ${sd_name} -port_name {AXI4mslave0_SLAVE0_BUSER} -port_direction {IN} -port_range {[3:0]}
...
sd_create_bus_port -sd_name ${sd_name} -port_name {AXI4mslave0_SLAVE0_RUSER} -port_direction {IN} -port_range {[3:0]}
...
sd_create_bus_port -sd_name ${sd_name} -port_name {AXI4mmaster0_MASTER0_BUSER} -port_direction {OUT} -port_range {[3:0]}
...
sd_create_bus_port -sd_name ${sd_name} -port_name {AXI4mmaster0_MASTER0_RUSER} -port_direction {OUT} -port_range {[3:0]}
...
sd_create_bus_port -sd_name ${sd_name} -port_name {AXI4mslave0_SLAVE0_ARUSER} -port_direction {OUT} -port_range {[3:0]}
...
sd_create_bus_port -sd_name ${sd_name} -port_name {AXI4mslave0_SLAVE0_AWUSER} -port_direction {OUT} -port_range {[3:0]}
...
sd_create_bus_port -sd_name ${sd_name} -port_name {AXI4mslave0_SLAVE0_WUSER} -port_direction {OUT} -port_range {[3:0]}
...
# Add SHLS_AXI4Interconnect_0 instance
sd_instantiate_component -sd_name ${sd_name} -component_name {SHLS_AXI4Interconnect} -instance_name {SHLS_AXI4Interconnect_0}

# Add scalar net connections
sd_connect_pins -sd_name ${sd_name} -pin_names {"ACLK" "SHLS_AXI4Interconnect_0:ACLK" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"ARESETN" "SHLS_AXI4Interconnect_0:ARESETN" }


# Add bus interface net connections
sd_connect_pins -sd_name ${sd_name} -pin_names {"AXI4mmaster0" "SHLS_AXI4Interconnect_0:AXI4mmaster0" }
...
foreach var [info vars SHLS*] {
    ...
    if {[file isdirectory $abs_smarthls_path]} {
        ...
        source script_support/components/APU/SMARTHLS/compile_and_integrate_to_libero.tcl
