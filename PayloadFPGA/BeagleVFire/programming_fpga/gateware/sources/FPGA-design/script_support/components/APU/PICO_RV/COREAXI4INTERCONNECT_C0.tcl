...
create_and_configure_core -download_core -core_vlnv {Actel:DirectCore:COREAXI4INTERCONNECT:*} -component_name {COREAXI4INTERCONNECT_C0} -params {\
"ADDR_WIDTH:32"  \
"CROSSBAR_MODE:0"  \
"DATA_WIDTH:32"  \
...
"MASTER0_DWC_DATA_FIFO_DEPTH:32"  \
