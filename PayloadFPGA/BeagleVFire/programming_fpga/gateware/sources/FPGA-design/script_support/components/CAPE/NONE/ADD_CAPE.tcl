...
sd_create_pin_slices -sd_name ${sd_name} -pin_name {BVF_RISCV_SUBSYSTEM:GPIO_2_M2F} -pin_slices {"[11:0]"} 
...
sd_connect_pins -sd_name ${sd_name} -pin_names {BVF_RISCV_SUBSYSTEM:GPIO_2_M2F[11:0] P8}
